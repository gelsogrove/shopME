...
export const n8nAuthMiddleware = (req: Request, res: Response, next: NextFunction) => {
  ...
  console.log('🔍 N8N AUTH DEBUG - All headers:', JSON.stringify(req.headers, null, 2));
  ...
  if (authHeader.startsWith('Basic ')) {
    ...
    console.log('🔍 N8N AUTH DEBUG - Decoded credentials:', { username, password: password ? '[HIDDEN]' : 'missing' });
