...
console.log('\n1. 🎯 **FUNZIONE CHIAMATA**:');
console.log(`   Script: ${scriptResults.functionCalled} (Chiamata corretta per offerte)`);
console.log(`   Sistema: ${systemResults.functionCalled} (Fallback a FAQ generica)`);
console.log(`   ⚠️  DIFFERENZA: Sistema non riconosce trigger per GetActiveOffers`);

console.log('\n2. 📊 **FONTE DATI**:');
console.log(`   Script: ${scriptResults.dataSource} (Dati strutturati per offerte)`);
...
console.log('\n3. 🎨 **QUALITÀ RISPOSTA**:');
console.log(`   Script: Risposta strutturata con offerte specifiche, percentuali, date`);
console.log(`   Sistema: Risposta generica su sconti per grandi ordini`);
console.log(`   ⚠️  DIFFERENZA: Script fornisce informazioni concrete, sistema risposta vaga`);
...
console.log(`   Script: ${scriptResults.response.length} caratteri (dettagliata)`);
