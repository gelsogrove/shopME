...
export const getDashboardAnalytics = async (
  ...
  const response = await api.get(`/analytics/${workspaceId}/dashboard?${params.toString()}`);
...
export const getDetailedMetrics = async (
  ...
  const response = await api.get(`/analytics/${workspaceId}/detailed?${params.toString()}`);
  return response.data;
};
