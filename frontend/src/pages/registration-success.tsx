...
const RegistrationSuccess = () => {
  ...
  // Redirect to WhatsApp or home page
  const goToWhatsApp = () => {
    // Try to deep link to WhatsApp using the scheme
    window.location.href = 'whatsapp://send?text=Hello%20again';
  };
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-10 text-center">
          ...
          <h1 className="text-3xl font-bold text-white mt-4">Registration Successful!</h1>
        </div>

        {/* Content */}
        <div className="px-6 py-8">
          <p className="text-gray-700 text-lg text-center mb-6">
            Thank you for completing your registration. You can now return to WhatsApp to continue your conversation.
          </p>
          ...
          <ul className="space-y-3 text-gray-600">
            <li className="flex items-start">
              ...
              <p className="ml-3">You'll receive a welcome message on WhatsApp</p>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0">
                <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="ml-3">You can now browse products and services via WhatsApp</p>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0">
                <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="ml-3">Your preferences have been saved and will be used to personalize your experience</p>
            </li>
          </ul>
